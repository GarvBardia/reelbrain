// obsidianui.dev — "Light Lines". Vendored (copy-the-source-in), same model as
// the magic/ and aceternity/ folders: shadcn-style registries hand you code you
// own, not an npm dependency. Fetched from https://obsidianui.dev/r/light-lines.json
//
// USED ON WHITE, which the upstream defaults are not written for: `lineColor`
// and `lightColor` both default to #fff (invisible on our background). Every
// colour is a prop, so the call site in src/app/page.tsx passes slate/indigo
// values instead. Unmodified otherwise.
"use client";
